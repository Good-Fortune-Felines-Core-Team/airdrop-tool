...
Completed transfers will be in a file named `{YYYY-MM-DD-HH-MM-SS}-{accounts-file-name}-completed.json`, and any failed transfers will be in a file named `{YYYY-MM-DD-HH-MM-SS}-{accounts-file-name}-failed.json`.
